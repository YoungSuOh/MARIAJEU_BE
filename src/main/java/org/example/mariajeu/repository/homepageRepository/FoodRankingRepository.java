...
public interface FoodRankingRepository extends JpaRepository<FoodArticle, Long> {
    ...
    List<FoodArticle> findFoodArticlesByViewsRankingByWineType(@Param("wineTypes") List<WineType> wineTypes);
    ...
    List<FoodArticle> findFoodArticlesByCommentsRankingByWineType(@Param("wineTypes") List<WineType> wineTypes);
    ...
    List<FoodArticle> findFoodArticlesByLikesRankingByWineType(@Param("wineTypes") List<WineType> wineTypes);
